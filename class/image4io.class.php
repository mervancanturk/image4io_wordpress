...
class Image4IO
{
	...
	public function copys($source = '', $target = '')
	{
		...
		$query = $this->query('https://api.image4.io/v0.1/copy', 'PUT', array('source' => $source, 'target_path' => $target), $headers);
	...
	public function move($source = '', $target = '')
	{
		...
		$query = $this->query('https://api.image4.io/v0.1/move?source=' . $source . '&target_path=' . $target, 'PUT', array(), $headers);
	...
	public function deletefolder($name = '')
	{
		...
		$query = $this->query('https://api.image4.io/v0.1/deletefolder?path=' . $name, 'DELETE', '', $headers);
